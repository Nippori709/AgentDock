...
export function gitStatus(config: LocalWorkspaceBridgeConfig, workspace: Workspace, guard?: PathGuard, filePath?: string, staged = false): string {
...
export function gitDiff(config: LocalWorkspaceBridgeConfig, guard: PathGuard, workspace: Workspace, filePath?: string, staged = false): string {
...
export function gitDiffNumstat(config: LocalWorkspaceBridgeConfig, guard: PathGuard, workspace: Workspace, filePath?: string, staged = false): string {
...
export function gitDiffStatus(config: LocalWorkspaceBridgeConfig, guard: PathGuard, workspace: Workspace, filePath?: string, staged = false): string {
...
export function gitLog(config: LocalWorkspaceBridgeConfig, workspace: Workspace, maxCount = 8): string {
